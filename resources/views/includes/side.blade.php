                        ...
                        <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarEcommerce">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{route('employees.show')}}" class="nav-link" data-key="t-product-Details"> View </a>
                                                </li>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div class="collapse menu-dropdown" id="sidebarProjects">
                                            <ul class="nav nav-sm flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{route('departments.show')}}" class="nav-link" data-key="t-overview"> View </a>
                                                </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarCrypto" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCrypto"> Leaves 
                                        </a>
